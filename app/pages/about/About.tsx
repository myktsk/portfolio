          ...
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
                Hi, I'm Miyuki! A web developer with over 8 years of experience
                building user-friendly, high-performance web applications. I've
                also spent 2+ years in marketing and sales, giving me a unique
                perspective on how technology, design, and business strategy
                come together.
              </p>
